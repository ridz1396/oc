		...
		<div class="page-header">
			<div class="container-fluid">
				<div class="pull-right">
					<button type="submit" form="form-featured-category" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
		...
		<div class="container-fluid">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-featured-category" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<div id="featured-category" class="well well-sm" style="height: 150px; overflow: auto;">
									<?php foreach ($categories as $categorynm) { ?>
										<div id="featured-category<?php echo $categorynm['category_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $categorynm['name']; ?>
											<input type="hidden" name="category[]" value="<?php echo $categorynm['category_id']; ?>" />
										</div>
									<?php } ?>
								</div>
							</div>
